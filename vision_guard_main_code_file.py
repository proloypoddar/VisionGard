...
class VisionGuard:
    def __init__(self,
        ...
        """
        Initialize the Vision Guard system.
    ...
    def create_perspective_views(self, frame):
        """
        Create left and right perspective views from the frame.
        Uses a simple split of the frame into left and right halves.

        Args:
            frame (numpy.ndarray): The image frame.

        Returns:
            tuple: Left and right perspective views.
        """
    ...
    def create_obstacle_map(self, obstacles):
        ...
        Args:
            obstacles (list): List of obstacle dictionaries with 'bbox' key.
    ...
    def draw_navigation_arrow(self, frame, door_center_x):
        ...
        Returns:
            numpy.ndarray: Frame with navigation arrow drawn.
        """
        frame_center_x = self.frame_width // 2
        arrow_length = 50
    ...
    def process_loop(self):
        ...
        try:
            ...
            while self.running:
                ...
                # Create a grid of additional views
                # Make grid cells larger for better visibility
                ...
                # The stereo view already has labels added in the create_perspective_views method
